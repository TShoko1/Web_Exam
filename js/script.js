...
function appFormModalHandler() { //функция обрабатывает данные из полей ввода в модальном окне.
    const hoursNumber = document.querySelector('.modal-hour-input');
    const date = document.querySelector('.modal-date-input');
    const time = document.querySelector('.modal-time-input');
    const peopleCount = document.querySelector('.modal-people-count-input');
...
function modalBtnSendHandler() { //функция вызывается при нажатии кнопки отправки заявки.
...
function updatePrice() { //функция обновляет отображение итоговой стоимости экскурсии на веб-странице.
...
function dataCorrectnessCheck() { //функция проверяет корректность введенных пользователем данных, таких как длительность экскурсии, дата, время, количество человек и другие параметры.
    let flag = true;
    const hoursNumber = document.querySelector('.modal-hour-input');
    const date = document.querySelector('.modal-date-input');
    const time = document.querySelector('.modal-time-input');
